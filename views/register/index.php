    ...
    >
      <div class="inner-container">
        ...
        <?php if(isset($error) && $error === "dataint") : ?>
				<p style="color: red;">Terdapat data yang kosong atau password yang diinputkan tidak sama. Coba lagi!</p>
        <?php endif; ?>
        <?php if(isset($error) && $error === "datadep") : ?>
        <p style="color: red;">Email yang Anda masukkan telah terdaftar!</p>
        <?php endif; ?>
      </div>
    </div>
    <script>
